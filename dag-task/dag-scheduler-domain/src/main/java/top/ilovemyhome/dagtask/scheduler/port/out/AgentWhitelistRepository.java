...
/**
 * Outbound port for {@link AgentWhitelist} persistence. Implementations live in
 * dag-scheduler-adapter-persistence-jdbc (or any other persistence adapter).
 */
public interface AgentWhitelistRepository {
     ...
     * Implementations should perform this as a single indexed lookup where possible.
     *
