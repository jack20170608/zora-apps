 ...
 *
 * @see RegisterAgentUseCase Registration use case
 * @see AgentHeartbeatUseCase Heartbeat use case
 * @see ReportTaskResultUseCase Result reporting use case
 */
...
public class AgentRegistryApi {
    ...
    /**
     * Creates a new AgentRegistryApi with injected dependencies.
     *
     * @param registerAgentUseCase the use case for agent registration
     * @param agentHeartbeatUseCase the use case for agent heartbeats
     * @param reportTaskResultUseCase the use case for reporting task results
     */
    @Inject
