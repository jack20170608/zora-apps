 ...
 * <p>
 * This API provides template management operations using hexagonal architecture ports:
 * <ul>
 ...
 * @see QueryTaskTemplateUseCase Read operations
 * @see ManageTaskTemplateUseCase Write operations
 */
...
public class TaskTemplateApi {
    ...
    /**
     * Creates a new TaskTemplateApi with injected dependencies.
     *
     * @param queryTemplateUseCase the use case for template queries
     * @param manageTemplateUseCase the use case for template modifications
     */
    @Inject
    ...
    public Response create(
        ...
        boolean success = manageTemplateUseCase.createTemplate(template, setActive);
        if (!success) {
    ...
    public Response update(
        ...
        boolean success = manageTemplateUseCase.updateTemplate(template);
        if (!success) {
            return Response.status(Response.Status.BAD_REQUEST)
    ...
    public Response deactivate(
        ...
        @PathParam("version") String version) {
        boolean success = manageTemplateUseCase.deactivateVersion(templateKey, version);
        if (!success) {
            return Response.status(Response.Status.BAD_REQUEST)
                .entity(ResEntityHelper.badRequest(
    ...
    public Response delete(
        ...
        @PathParam("version") String version) {
        boolean success = manageTemplateUseCase.deleteVersion(templateKey, version);
        if (!success) {
            return Response.status(Response.Status.BAD_REQUEST)
                .entity(ResEntityHelper.badRequest(
    ...
    public Response search(
        ...
        List<TaskTemplate> templates = queryTemplateUseCase.findAll(searchCriteria);
